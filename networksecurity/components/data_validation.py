...
class DataValidation:
    ...
    def validate_integer_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            invalid_columns = []
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            if not status:
                ...
                logging.error(error_message)
            status=self.validate_integer_columns(dataframe=train_dataframe)
            status=self.validate_integer_columns(dataframe=test_dataframe)
